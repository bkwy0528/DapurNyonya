...
export default function ProfilePage({ user, onLogout }: ProfilePageProps) {
  ...
  const backLink = user.role === 'customer' ? '/customer/home' : '/admin/dashboard';
    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="bg-gradient-to-r from-orange-500 to-amber-500 text-white p-6">
        <div className="max-w-4xl mx-auto">
          <Link to={backLink} className="inline-flex items-center text-white hover:text-gray-100 mb-4">
